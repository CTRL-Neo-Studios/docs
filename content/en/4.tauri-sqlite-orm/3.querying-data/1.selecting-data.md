...
The `.where()` clause filters your results. It accepts a condition object from one of the [[3.5 - Conditions & Operators]].
...
> **Note:** For more complex aggregations that require aliasing, you may need to use joins or raw SQL. See [[4.2 - Joins]] and [[4.5 - Raw SQL]].
